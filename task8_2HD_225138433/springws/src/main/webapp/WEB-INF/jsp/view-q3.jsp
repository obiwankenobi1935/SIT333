...
<style>
  ...
  h2 { color: #2c3e50; } .badge { background: #9b59b6; color: white; padding: 3px 10px; border-radius: 20px; font-size: 13px; }
...
<body>
  <div class="card">
    <h2>Q3 <span class="badge">Multiplication</span></h2>
    ...
    <form action="/q3" method="post">
      ...
      <label>Your Answer (num1 x num2):</label>
